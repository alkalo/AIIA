...
When the goal is real estate / property listings (opportunitySubtype real_estate): set output.schema to title, location, price, summary, url, score, reason. Queries MUST be in the user's language for local markets (Spanish for Spain/Catalonia). Use ONLY real portals: site:idealista.com, site:fotocasa.es, site:habitaclia.com, site:milanuncios.com, site:pisos.com, site:yaencontre.com. NEVER invent domains (no realestate.com.au, no fake *.com portals). Include zone/comarca names and max price in queries. Set maxSources to 25–40.
