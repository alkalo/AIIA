...
PART A — Open grants & funding (8–12 items)
Find currently open or newly announced grants relevant to:
social enterprise, community wellbeing, First Nations enterprise, regional/rural communities,
WISE/inclusive employment, circular economy, tech for good, charities/NGOs, Queensland and national AU.
For each: program_name, organization, max_funding, currency, deadline (if known), short description, url (https deep link).
