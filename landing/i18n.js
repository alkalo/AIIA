const strings = {
  en: {
    ...
    "nav.faq": "FAQ",
    "hero.title": "Local AI chat and agents that search for you",
    "hero.subtitle":
    ...
    "features.agents.title": "Chat + custom agents",
    "features.agents.desc":
      "Talk to AIIA Chat like ChatGPT (local and free). Or describe a goal — jobs, grants, suppliers — and publish up to 5 scheduled search agents.",
    "features.local.title": "100% local",
    "features.local.desc":
      "Ollama runs on your PC. Data, credentials, and AI never leave your machine. Internet is only used for chat web tools or agent runs.",
    ...
    "req.ollama": "Ollama installed manually (AIIA opens the download page and prepares the model)",
    "req.ram": "8 GB RAM minimum (16 GB recommended for Deep/Pro modes)",
    "req.internet": "Internet for chat web tools and agent runs (search only)",
    ...
    "download.step2": "Install Ollama from ollama.com, then let AIIA prepare the recommended model for your PC",
    "download.step3": "Open AIIA Chat or create your first agent",
    "download.note": "First launch needs internet to download Ollama and AI models. After setup, chat and agents run locally.",
    "faq.title": "FAQ",
    "faq.q1": "Is AIIA free?",
    "faq.a1":
      "Yes. The app, local AI (Ollama), chat, and web search during tools/runs are free. You only need your own PC.",
    "faq.q2": "Does my data leave my computer?",
    "faq.a2":
      "No. Chats, agents, results, and credentials stay on your machine. Internet is used only to search and read public web pages when you ask or an agent runs.",
  ...
  es: {
    ...
    "nav.faq": "FAQ",
    "hero.title": "Chat e agentes de IA local que buscan por ti",
    "hero.subtitle":
    ...
    "features.agents.title": "Chat + agentes personalizados",
    "features.agents.desc":
      "Habla con AIIA Chat como con ChatGPT (local y gratis). O describe un objetivo — empleo, grants, proveedores — y publica hasta 5 agentes de búsqueda programados.",
    "features.local.title": "100% local",
    "features.local.desc":
      "Ollama corre en tu PC. Datos, credenciales e IA nunca salen de tu máquina. Internet solo se usa en tools del chat o en ejecuciones de agentes.",
    ...
    "req.ollama": "Ollama instalado a mano (AIIA abre la descarga y prepara el modelo)",
    "req.ram": "8 GB RAM mínimo (16 GB recomendado para modos Profundo/Pro)",
    "req.internet": "Internet para tools del chat y ejecuciones de agentes (solo búsqueda)",
    ...
    "download.step2": "Instala Ollama desde ollama.com; luego AIIA prepara el modelo recomendado para tu PC",
    "download.step3": "Abre AIIA Chat o crea tu primer agente",
    "download.note": "El primer arranque necesita internet para descargar Ollama y los modelos. Después, chat y agentes corren en local.",
    "faq.title": "Preguntas frecuentes",
    "faq.q1": "¿AIIA es gratis?",
    "faq.a1":
      "Sí. La app, la IA local (Ollama), el chat y la búsqueda web en tools/ejecuciones son gratis. Solo necesitas tu PC.",
    "faq.q2": "¿Mis datos salen del ordenador?",
    "faq.a2":
      "No. Chats, agentes, resultados y credenciales permanecen en tu máquina. Internet solo se usa para buscar y leer páginas públicas cuando lo pides o un agente se ejecuta.",
